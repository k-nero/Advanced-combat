package com.kingsman.hyper.reg.world.structures;
...
public class TestStructure extends StructureFeature<JigsawConfiguration>
{
    ...
    public TestStructure()
    {
        ...
        super(CODEC, TestStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context)
    {
        ...
        if (!TestStructure.isFeatureChunk(context))
        {
        ...
        if (structurePiecesGenerator.isPresent())
        {
            ...
            ProjectHyper.LOGGER.log(Level.DEBUG, "Rundown House at {}", blockpos);
        }
